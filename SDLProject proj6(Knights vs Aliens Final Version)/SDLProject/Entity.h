...
enum EntityType { PLATFORM, PLAYER, ENEMY, POWERUP  };
...
public:
    ...
    bool collided_with_power_bottom = false;
    bool collided_with_power_top = false;
    bool collided_with_power_left = false;
    bool collided_with_power_right = false;
    ...
    void update(float delta_time, Entity *player, Entity *objects, int object_count, Map *map, Entity *power, int power_count);
    ...
    bool  check_colly(Entity *other);
    bool  check_collx(Entity *other);
