...
//  SDLProject
//
//  Created by Nathan Atherley on 5/26/22.
...
const char PLAYER_SPRITE_FILEPATH[] = "soccer_ball.png";
const char PLAYER_SPRITE_FILEPATH2[] = "yellow.png";
...
void update()
{
    ...
    scale_vector = glm::vec3(1.5f, 1.5f, 1.0f);
    /* Translate -> Rotate */
    ...
    model_matrix2 = glm::translate(model_matrix2, glm::vec3(-triangle_x, 0.0f, 0.0f));
}
